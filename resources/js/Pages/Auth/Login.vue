  ...
  <main class="grid place-items-center min-h-screen">
    <section class="bg-white p-8 rounded-xl max-w-md mx-auto border w-full">
      ...
      <form @submit.prevent="submit">
        <div class="mb-6">
          <label class="block mb-2 uppercase font-bold text-xs text-gray-700" for="email"> Username </label>

          <input v-model="form.username" class="border p-2 w-full rounded" type="text" name="username" id="email" required />
